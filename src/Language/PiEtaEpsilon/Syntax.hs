...
data Type = Zero | One | Sum Type Type | Product Type Type | Negative Type | Reciprocal Type deriving(Eq, Ord, Show, Read, Data, Typeable, Generic)
...
data Iso = Eliminate IsoBase | Introduce IsoBase deriving (Eq, Ord, Show, Read)
data Term = Base Iso | Id Type | Term ::: Term | Term :+: Term | Term :*: Term deriving (Eq, Ord, Show, Read)
